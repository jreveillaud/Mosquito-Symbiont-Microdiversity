...
# params for dendogram plot
plot(hca.ward, cex=0.7) 
rh <- rect.hclust(hca.ward, k=3, border = c("red", "blue", "green"))
...
# dendogram plot
plot(hca.ward, cex=0.7) 
rect.hclust(hca.ward, k=3, border = c("red", "blue", "green"))
text(x=beg_clus, y=y_clus, col=c("red","blue", "green"), labels=c("High infection", "Low infection", "Medium infection"), font=2)

# save plot
tiff("../../../../output/1_MED/1E/1Ec_dendogram.tiff", units="in", width=18, height=8, res=300)
plot(hca.ward, cex=0.7, xlab="Samples", sub="")
rect.hclust(hca.ward, k=3, border = c("red", "blue", "green"))
text(x=beg_clus, y=y_clus, col=c("red","blue", "green"), labels=c("High infection", "Low infection", "Medium infection"), font=2)
dev.off()

png("../../../../output/1_MED/1E/1Ec_dendogram.png", units="in", width=18, height=8, res=300)
plot(hca.ward, cex=0.7, xlab="Samples", sub="")
rect.hclust(hca.ward, k=3, border = c("red", "blue", "green"))
text(x=beg_clus, y=y_clus, col=c("red","blue", "green"), labels=c("High infection", "Low infection", "Medium infection"), font=2)
dev.off()
...
```{r warning=FALSE}
# load qPCR file
qpcr <- read.xlsx("../../../../additional_data/quanttiWolbachiaschriekeetal.xlsx")
...
metadata <- openxlsx::read.xlsx("../../../../additional_data/Supplementary_Table_1_V4_Shorten_w_ReadDepth_CheckqPCR.xlsx", sheet=1)
...
# params for dendogram plot
plot(hca.ward, cex=0.7) 
rh <- rect.hclust(hca.ward, k=2, border = c("green", "red"))
beg_clus <- head(cumsum(c(1, lengths(rh))), -1)
beg_clus <- beg_clus + 2
beg_clus[2] <- beg_clus[2] + 6
y_clus <- 15

# dendogram plot
plot(hca.ward, cex=0.7) 
rect.hclust(hca.ward, k=2, border = c("green", "red"))
text(x=beg_clus, y=y_clus, col=c("green", "red"), labels=c("Medium infection", "High infection"), font=2)
```
...
# save
write.table(all.groups.comparison, "../../../../output/1_MED/1E/1Ec_qpcr_comparison.tsv", sep="\t", row.names = FALSE, col.names=TRUE)

tiff("../../../../output/1_MED/1E/1Ec_boxplot.tiff", units="in", width=10, height=5, res=300)
p1
dev.off()

png("../../../../output/1_MED/1E/1Ec_boxplot.png", units="in", width=10, height=5, res=300)
p1
dev.off()
```
...
p1 <- plot_ordination(ps_percent_whole, bray.culex_whole, color="Infection", shape=NA) +
  ...
  scale_color_manual(values=c("blue", "green","red"), breaks=c("Low infection", "Medium infection", "High infection"))+
...
p6 <- plot_ordination(ps_percent_whole, bray.culex_whole, color="Strain", shape=NA) +
  ...
  scale_color_manual("Strain", 
                     ...
                     labels = c("Field - Guadeloupe", 
                                ...
                                "Field - Camping Europe", 
                                "Laboratory - Lavar"))+
  scale_shape_manual(values = c(15,4,17), labels=c(expression(italic("Aedes aegypti")), expression(italic("Culex pipiens")), expression(italic("Culex quinquefasciatus"))))+
  theme_gray()+
  #labs(caption=paste("stress:", bray.culex_whole$stress %>% round(2), "\n", "ellipse level: 0.95"))+
  guides(fill = guide_legend(order = 1),
         colour = guide_legend(order = 2),
...
#### Compare Wolbachia abundance by strain in Culex pipiens
...
#### Compare Wolbachia qPCR quantity by strain in Culex pipiens
...
#### Correlation test between Wolbachia relative abundance and Wolbachia qPCR quantity
...
# save
tiff("../../../../output/1_MED/1E/1Ec_NMDS_main.tiff", units="in", width=8, height=5, res=300)
p6
dev.off()

tiff("../../../../output/1_MED/1E/1Ec_NMDS_supp.tiff", units="in", width=16, height=5, res=300)
p_group2
dev.off()

tiff("../../../../output/1_MED/1E/1Ec_MED_panels.tiff", units="in", width=14, height=10, res=300)
p_group
dev.off()

png("../../../../output/1_MED/1E/1Ec_NMDS_main.png", units="in", width=8, height=5, res=300)
p6
dev.off()

png("../../../../output/1_MED/1E/1Ec_NMDS_supp.png", units="in", width=16, height=5, res=300)
p_group2
dev.off()

png("../../../../output/1_MED/1E/1Ec_MED_panels.png", units="in", width=14, height=10, res=300)
p_group
dev.off()
```
...
## Bosc / Lavar
table(ps_pipiens_whole_bosc_lavar@sam_data$Species, ps_pipiens_whole_bosc_lavar@sam_data$Strain) %>% addmargins() -> contingency_1
contingency_1
...
ss <- as(sample_data(ps_pipiens_whole_bosc_lavar), "data.frame")

# betadisper uses the distance matrix to calculate the multivariate dispersions (variances; average distance to centroids)
# we use group dispersions to perform an ANOVA test and we observe that the ANOVA's p-value is not significant meaning that group dispersions are homogenous ("Null hypothesis of no difference in dispersion between groups"

anova(betadisper(vegdist(t(otu_table(ps_pipiens_whole_bosc_lavar)), method="bray"), ss$Field)) -> hetero_1
hetero_1

res_adonis1 <- adonis_field_bosc_lavar$aov.tab
res_adonis1 <- fill_significance(res_adonis1,"Pr(>F)")

hetero_1 <- fill_significance(hetero_1,"Pr(>F)")

## Camping / Lavar
table(ps_pipiens_whole_camping_lavar@sam_data$Species, ps_pipiens_whole_camping_lavar@sam_data$Strain) %>% addmargins() -> contingency_2
contingency_2
...
ss <- as(sample_data(ps_pipiens_whole_camping_lavar), "data.frame")
anova(betadisper(vegdist(t(otu_table(ps_pipiens_whole_camping_lavar)), method="bray"), ss$Field)) -> hetero_2
hetero_2

res_adonis2 <- adonis_field_camping_lavar$aov.tab
res_adonis2 <- fill_significance(res_adonis2,"Pr(>F)")
hetero_2 <- fill_significance(hetero_2,"Pr(>F)")

## Bosc / Camping
table(ps_pipiens_whole_bosc_camping@sam_data$Species, ps_pipiens_whole_bosc_camping@sam_data$Strain) %>% addmargins() -> contingency_3
contingency_3
...
ss <- as(sample_data(ps_pipiens_whole_bosc_camping), "data.frame")
anova(betadisper(vegdist(t(otu_table(ps_pipiens_whole_bosc_camping)), method="bray"), ss$Strain)) -> hetero_3
hetero_3

res_adonis3 <- adonis_field_bosc_camping$aov.tab
res_adonis3 <- fill_significance(res_adonis3,"Pr(>F)")
hetero_3 <- fill_significance(hetero_3,"Pr(>F)")
```

```{r warning=FALSE}
# Excel
wb <- loadWorkbook("../../../../output/1_MED/1E/Supplementary_Table_2.xlsx")
addWorksheet(wb, "NMDS and heteroscedasticity")

writeData(wb, "NMDS and heteroscedasticity", "Effect of lab and location field in the Culex pipiens samples", startCol = 1, startRow = 25)
writeData(wb, "NMDS and heteroscedasticity", "ADONIS (Analysis of variance using distance matrices):", startCol = 1, startRow = 27)
writeData(wb, "NMDS and heteroscedasticity", "Lavar / Bosc:", startCol = 1, startRow = 29)
writeData(wb, "NMDS and heteroscedasticity", res_adonis1, startCol = 1, startRow = 30, rowNames=TRUE)
writeData(wb, "NMDS and heteroscedasticity", "Lavar / Camping Europe:", startCol = 1, startRow = 35)
writeData(wb, "NMDS and heteroscedasticity", res_adonis2, startCol = 1, startRow = 36, rowNames=TRUE)
writeData(wb, "NMDS and heteroscedasticity", "Bosc / Camping Europe:", startCol = 1, startRow = 41)
writeData(wb, "NMDS and heteroscedasticity", res_adonis3, startCol = 1, startRow = 42, rowNames=TRUE)

writeData(wb, "NMDS and heteroscedasticity", "Homoscedasticity (betadisper)", startCol = 10, startRow = 27)
writeData(wb, "NMDS and heteroscedasticity", hetero_1, startCol = 10, startRow = 30, rowNames=TRUE)
writeData(wb, "NMDS and heteroscedasticity", hetero_2, startCol = 10, startRow = 36, rowNames=TRUE)
writeData(wb, "NMDS and heteroscedasticity", hetero_3, startCol = 10, startRow = 42, rowNames=TRUE)

writeData(wb, "NMDS and heteroscedasticity", "Contingency table (sample size)", startCol = 18, startRow = 27)
writeData(wb, "NMDS and heteroscedasticity", contingency_1, startCol = 18, startRow = 30, rowNames=TRUE)
writeData(wb, "NMDS and heteroscedasticity", contingency_2, startCol = 18, startRow = 36, rowNames=TRUE)
writeData(wb, "NMDS and heteroscedasticity", contingency_3, startCol = 18, startRow = 42, rowNames=TRUE)
...
# Adonis method
table(ps_quinque_whole@sam_data$Species, ps_quinque_whole@sam_data$Strain) %>% addmargins() -> contingency_4
contingency_4
...
ss <- as(sample_data(ps_quinque_whole), "data.frame")
anova(betadisper(vegdist(t(otu_table(ps_quinque_whole)), method="bray"), ss$Field)) -> hetero_4
hetero_4

res_adonis4 <- adonis_antibiotics$aov.tab %>% as.data.frame()
res_adonis4 <- fill_significance(res_adonis4,"Pr(>F)")
hetero_4 <- fill_significance(hetero_4, "Pr(>F)")
```

```{r warning=FALSE}
writeData(wb, "NMDS and heteroscedasticity", "Effect of tetracycline in the Culex quinquefasciatus samples", startCol = 1, startRow = 13)
writeData(wb, "NMDS and heteroscedasticity", "ADONIS (Analysis of variance using distance matrices):", startCol = 1, startRow = 15)
writeData(wb, "NMDS and heteroscedasticity", res_adonis4, startCol = 1, startRow = 17, rowNames=TRUE)


writeData(wb, "NMDS and heteroscedasticity", "Homoscedasticity (betadisper)", startCol = 10, startRow = 15)
writeData(wb, "NMDS and heteroscedasticity", hetero_4, startCol = 10, startRow = 17, rowNames=TRUE)

writeData(wb, "NMDS and heteroscedasticity", "Contingency table (sample size)", startCol = 18, startRow = 15)
writeData(wb, "NMDS and heteroscedasticity", contingency_4, startCol = 18, startRow = 17, rowNames=TRUE)
...
table(ps_whole_field@sam_data$Species, ps_whole_field@sam_data$Strain) %>% addmargins() -> contingency_5
contingency_5
...
ss <- as(sample_data(ps_whole_field), "data.frame")
anova(betadisper(vegdist(t(otu_table(ps_whole_field)), method="bray"), ss$Strain)) -> hetero_5
hetero_5

res_adonis5 <- adonis_whole_field$aov.tab
res_adonis5 <- fill_significance(res_adonis5,"Pr(>F)")
hetero_5 <- fill_significance(hetero_5, "Pr(>F)")
```

```{r warning=FALSE}
writeData(wb, "NMDS and heteroscedasticity", "Effect of species in the field samples", startCol = 1, startRow = 1)
writeData(wb, "NMDS and heteroscedasticity", "ADONIS (Analysis of variance using distance matrices):", startCol = 1, startRow = 3)
writeData(wb, "NMDS and heteroscedasticity", res_adonis5, startCol = 1, startRow = 5, rowNames=TRUE)

writeData(wb, "NMDS and heteroscedasticity", "Homoscedasticity (betadisper)", startCol = 10, startRow = 3)
writeData(wb, "NMDS and heteroscedasticity", hetero_5, startCol = 10, startRow = 5, rowNames=TRUE)

writeData(wb, "NMDS and heteroscedasticity", "Contingency table (sample size)", startCol = 18, startRow = 3)
writeData(wb, "NMDS and heteroscedasticity", contingency_5, startCol = 18, startRow = 5, rowNames=TRUE)
...
table(ps_pipiens_whole@sam_data$Strain, ps_pipiens_whole@sam_data$Infection) %>% addmargins() -> contingency_6
contingency_6
...
ss <- as(sample_data(ps_pipiens_whole), "data.frame")
anova(betadisper(vegdist(t(otu_table(ps_pipiens_whole)), method="bray"), ss$Strain)) -> hetero_6

res_adonis6 <- adonis_whole_infection$aov.tab
res_adonis6 <- fill_significance(res_adonis6,"Pr(>F)")
hetero_6 <- fill_significance(hetero_6, "Pr(>F)")
```

```{r warning=FALSE}
writeData(wb, "NMDS and heteroscedasticity", "Effect of Wolbachia infection (HCA groups) and Strain in Culex pipiens", startCol = 1, startRow = 50)
writeData(wb, "NMDS and heteroscedasticity", "ADONIS (Analysis of variance using distance matrices):", startCol = 1, startRow = 52)
writeData(wb, "NMDS and heteroscedasticity", res_adonis6, startCol = 1, startRow = 54, rowNames=TRUE)

writeData(wb, "NMDS and heteroscedasticity", "Homoscedasticity (betadisper)", startCol = 10, startRow = 52)
writeData(wb, "NMDS and heteroscedasticity", hetero_6, startCol = 10, startRow = 54, rowNames=TRUE)

writeData(wb, "NMDS and heteroscedasticity", "Contingency table (sample size)", startCol = 18, startRow = 52)
writeData(wb, "NMDS and heteroscedasticity", contingency_6, startCol = 18, startRow = 54, rowNames=TRUE)
...
table(ps_pipiens_whole_qpcr@sam_data$Strain, ps_pipiens_whole_qpcr@sam_data$Infection) %>% addmargins() -> contingency_7
contingency_7
...
ss <- as(sample_data(ps_pipiens_whole_qpcr), "data.frame")
anova(betadisper(vegdist(t(otu_table(ps_pipiens_whole_qpcr)), method="bray"), ss$Strain)) -> hetero_7
hetero_7

res_adonis7 <- adonis_whole_infection2$aov.tab
res_adonis7 <- fill_significance(res_adonis7,"Pr(>F)")
hetero_7 <- fill_significance(hetero_7, "Pr(>F)")
```

```{r warning=FALSE}
writeData(wb, "NMDS and heteroscedasticity", "Effect of Wolbachia infection (HCA groups), qPCR values and strain in Culex pipiens", startCol = 1, startRow = 63)
writeData(wb, "NMDS and heteroscedasticity", "ADONIS (Analysis of variance using distance matrices):", startCol = 1, startRow = 65)
writeData(wb, "NMDS and heteroscedasticity", res_adonis7, startCol = 1, startRow = 67, rowNames=TRUE)

writeData(wb, "NMDS and heteroscedasticity", "Homoscedasticity (betadisper)", startCol = 10, startRow = 65)
writeData(wb, "NMDS and heteroscedasticity", hetero_7, startCol = 10, startRow = 67, rowNames=TRUE)

writeData(wb, "NMDS and heteroscedasticity", "Contingency table (sample size)", startCol = 18, startRow = 65)
writeData(wb, "NMDS and heteroscedasticity", contingency_7, startCol = 18, startRow = 67, rowNames=TRUE)
