...
You need to download the data and process to a quality filtering as described in the manuscript (using the iu-filter-quality-minoche function from anvi'o with default parameters). You also need to create a sample file with the 3 columns : 
