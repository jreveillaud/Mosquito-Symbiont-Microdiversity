---
title: "Elizabethkingia (oligotyping)"
...
path_elizabeth <- "../../../../output/2_Oligotyping/2A/Elizabethkingia/2A_oligotyping_Elizabethkingia_sequences-c1-s1-a0.0-A0-M10"

# load the matrix count table
matrix_count <- read.table(paste0(path_elizabeth, "/MATRIX-COUNT.txt"), header = TRUE) %>% t()
...
fasta <- readDNAStringSet(paste0(path_elizabeth, "/OLIGO-REPRESENTATIVES.fasta"))
...
ref_oligo_med2 <- read.table("../../../../output/2_Oligotyping/2B/2B_REF_info_elizabethkingia.tsv", sep="\t", header = TRUE)
...
# add percent of Elizabethkingia
...
# round the percent of Elizabethkingia at 2 decimals
...
test3 <- test %>% select(c(Sample, Species, Strain, Organ, Read_depth, Read_elizabethkingia)) %>% reshape2::melt(id.vars=c("Sample", "Species", "Strain", "Organ"), vars=c("Read_depth", "Read_elizabethkingia"))
...
```{r warning=FALSE}
tiff("../../../../output/2_Oligotyping/2D/2Dd_OLIGO_counts_elizabethkingia.tiff", units="in", width=20, height=18, res=300)
p_counts
dev.off()

tiff("../../../../output/2_Oligotyping/2D/2Dd_OLIGO_taxonomic_elizabethkingia_whole.tiff", units="in", width=16, height=12, res=300)
p2
dev.off()

tiff("../../../../output/2_Oligotyping/2D/2Dd_OLIGO_taxonomic_elizabethkingia_ovary.tiff", units="in", width=18, height=14, res=300)
p3
dev.off()

tiff("../../../../output/2_Oligotyping/2D/2Dd_OLIGO_taxonomic_elizabethkingia.tiff", units="in", width=18, height=16, res=300)
p_taxo
dev.off()

png("../../../../output/2_Oligotyping/2D/2Dd_OLIGO_counts_elizabethkingia_big.png", units="in", width=20, height=18, res=300)
p_counts
dev.off()

png("../../../../output/2_Oligotyping/2D/2Dd_OLIGO_counts_elizabethkingia_small.png", units="in", width=18, height=14, res=300)
p_counts
dev.off()

png("../../../../output/2_Oligotyping/2D/2Dd_OLIGO_taxonomic_elizabethkingia_whole.png", units="in", width=16, height=12, res=300)
p2
dev.off()

png("../../../../output/2_Oligotyping/2D/2Dd_OLIGO_taxonomic_elizabethkingia_ovary.png", units="in", width=18, height=14, res=300)
p3
dev.off()

png("../../../../output/2_Oligotyping/2D/2Dd_OLIGO_taxonomic_elizabethkingia_big.png", units="in", width=18, height=18, res=300)
p_taxo
dev.off()

png("../../../../output/2_Oligotyping/2D/2Dd_OLIGO_taxonomic_elizabethkingia_small.png", units="in", width=18, height=14, res=300)
p_taxo
dev.off()
```
...
img <- magick::image_read(paste0(path_elizabeth, "/HTML-OUTPUT/entropy.png"))
...
tiff("../../../../output/2_Oligotyping/2D/2Dd_OLIGO_main_elizabethkingia.tiff", width=36, height=36, res=300, units="in")
t_plot
dev.off()

png("../../../../output/2_Oligotyping/2D/2Dd_OLIGO_main_elizabethkingia.png", width=36, height=36, res=300, units="in")
t_plot
dev.off()
```
