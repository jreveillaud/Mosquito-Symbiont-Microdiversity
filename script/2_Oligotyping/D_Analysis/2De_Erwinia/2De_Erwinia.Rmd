...
tiff("2De_OLIGO_taxonomic_erwinia.tiff", units="in", width=18, height=16, res=300)
p_taxo
dev.off()
...
png("2De_OLIGO_taxonomic_erwinia_whole.png", units="in", width=16, height=12, res=300)
p2
dev.off()

png("2De_OLIGO_taxonomic_erwinia_ovary.png", units="in", width=18, height=14, res=300)
p3
dev.off()
...
png("2De_OLIGO_main_erwinia.png", width=36, height=36, res=300, units="in")
t_plot
dev.off()
```
