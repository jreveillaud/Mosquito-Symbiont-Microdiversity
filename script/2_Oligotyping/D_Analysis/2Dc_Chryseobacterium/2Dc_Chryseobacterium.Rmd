...
setwd(paste0(path_oligo,"/chryseobacterium/oligotyping_Chryseobacterium_sequences-c3-s1-a0.0-A0-M10"))
...
ref_oligo_med2 <- read.table("2B_REF_info_chryseobacterium.tsv", sep="\t", header = TRUE)
...
tiff("2Dc_OLIGO_counts_chryseobacterium.tiff", units="in", width=20, height=18, res=300)
p_counts
dev.off()

tiff("2Dc_OLIGO_taxonomic_chryseobacterium_whole.tiff", units="in", width=16, height=12, res=300)
p2
dev.off()

tiff("2Dc_OLIGO_taxonomic_chryseobacterium_ovary.tiff", units="in", width=18, height=14, res=300)
p3
dev.off()

tiff("2Dc_OLIGO_taxonomic_chryseobacterium.tiff", units="in", width=18, height=16, res=300)
p_taxo
dev.off()

png("2Dc_OLIGO_counts_chryseobacterium_big.png", units="in", width=20, height=18, res=300)
p_counts
dev.off()

png("2Dc_OLIGO_counts_chryseobacterium_small.png", units="in", width=18, height=14, res=300)
p_counts
dev.off()

png("2Dc_OLIGO_taxonomic_chryseobacterium_whole.png", units="in", width=16, height=12, res=300)
p2
dev.off()

png("2Dc_OLIGO_taxonomic_chryseobacterium_ovary.png", units="in", width=18, height=14, res=300)
p3
dev.off()

png("2Dc_OLIGO_taxonomic_chryseobacterium_big.png", units="in", width=18, height=18, res=300)
p_taxo
dev.off()

png("2Dc_OLIGO_taxonomic_chryseobacterium_small.png", units="in", width=18, height=14, res=300)
p_taxo
dev.off()
```
...
setwd(paste0(path_oligo,"/chryseobacterium/oligotyping_Chryseobacterium_sequences-c3-s1-a0.0-A0-M10/HTML-OUTPUT"))
...
tiff("2Dc_OLIGO_main_chryseobacterium.tiff", width=36, height=36, res=300, units="in")
t_plot
dev.off()

png("2Dc_OLIGO_main_chryseobacterium.png", width=36, height=36, res=300, units="in")
t_plot
dev.off()
```
