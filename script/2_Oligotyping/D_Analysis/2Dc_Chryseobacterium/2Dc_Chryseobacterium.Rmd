...
test3 <- test %>% select(c(Sample, Species, Location, Organ, Read_depth, Read_chryseobacterium)) %>% reshape2::melt(id.vars=c("Sample", "Species", "Location", "Organ"), vars=c("Read_depth", "Read_chryseobacterium"))
